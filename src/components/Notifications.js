            ...
            <div className="notifications-content m-1.5">
                <div className="notifications-header flex justify-between mb-4">
                    ...
                    <span onClick={() => setOpen(false)}
                          className="notifications-close-button p-2 cursor-pointer rounded-lg hover:bg-gray-300 dark:hover:bg-gray-800 transition active:bg-gray-400 dark:active:bg-gray-900"><Close
                        size="33"/></span>
                </div>
                <hr/>
                <div className={`notifications-items mt-3 ${open ? 'block' : 'hidden'}`}>
                    <div
                        className="notification mb-3 w-full flex justify-between items-center px-3 py-3 rounded-lg bg-gray-50 dark:bg-gray-950 hover:bg-gray-100 dark:hover:bg-gray-900 transition-all duration-200">
                        ...
                        <img width="50px" src="https://i.pravatar.cc/150?u=a04258114e29026302d" alt="noti-photo"/>
                    </div>
                    <div
                        className="notification mb-3 w-full flex justify-between items-center px-3 py-3 rounded-lg bg-gray-50 dark:bg-gray-950 hover:bg-gray-100 dark:hover:bg-gray-900 transition-all duration-200">
                        <div className="flex items-center">
