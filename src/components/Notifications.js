...
export default function Notifications() {
    ...
    return (
        <div className={`notifications h-screen fixed right-0 bottom-0 border-l-1 drop-shadow-lg rounded-md border-black dark:border-neutral-600 rounded-r-none bg-white dark:bg-black ${notificationsOpen ? 'w-[80%] md:w-1/2 lg:w-1/3' : 'w-0'}`}>
