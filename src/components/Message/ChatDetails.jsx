...
export default function ChatDetails(props) {
    ...
    return (
        <>
            <div
                className={`h-screen w-96 fixed top-0 shadow-lg bg-white dark:bg-neutral-900 dark:border-l-2 dark:border-l-neutral-600 transition-all duration-200 ${props.detailsBarOpen ? 'right-0' : '-right-[1000px]'}`}>
