...
import {Report} from '@styled-icons/material/Report';
            ...
            <NotificationsContext.Provider value={{notificationsOpen: notificationsOpen, setNotificationsOpen: setNotificationsOpen}}>
                <div className="flex justify-center h-screen">
                            ...
                            <div
                                ...
                                <div className="py-1 bg-neutral-100 dark:bg-neutral-900 w-full rounded-2xl">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <Carousel useKeyboardArrows={true} swipeable={true} emulateTouch={true} showArrows={true} showThumbs={false} showStatus={false} dynamicHeight={true}>
                                            ...
                                            <div onClick={() => setEnlargeView(true)}>
                                                <video controls className="card-image mt-2 object-cover w-full h-auto max-h-[800px] cursor-pointer active:blur-sm transition-all duration-75">
                                                    <source src="https://sample-videos.com/video321/mp4/720/big_buck_bunny_720p_1mb.mp4"/>
                                                </video>
                                            </div>
                                        </Carousel>
                                    </div>
                    ...
                    <div className="report-modal">
                        <Modal size="3xl" isOpen={reportSectionOpen} onClose={()=>setReportSectionOpen(false)}>
                            <ModalContent>
                                {()=>(
                                    <>
                                        <ModalHeader>
                    ...
                    <div
                        className={`z-20 post-enlarge w-screen flex justify-between h-screen bg-black bg-opacity-75 backdrop-blur fixed ${enlargeView ? 'block' : 'hidden'}`}>
                        <div className="m-5 flex">
                            <div onClick={() => zoomIn()} className='mx-1.5 cursor-pointer text-white'><ZoomIn size="30"/></div>
                            <div onClick={() => zoomOut()} className='mx-1.5 cursor-pointer text-white'><ZoomOut size="30"/></div>
                        </div>
                        <div
                        ...
                        <div onClick={() => setEnlargeView(false)} className='enlarge-view-close cursor-pointer m-5 text-white'>
